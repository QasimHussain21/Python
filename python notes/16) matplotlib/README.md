# 📊 Lecture 16: Matplotlib in Python
...
A **Line Plot** is used to show trends, changes, and patterns across values or over time.
...
Matplotlib allows us to customize graphs using different properties such as markers, line styles, line width, titles, labels, and grids.
...
| `plt.title()`   | Add a graph title          |
| `plt.xlabel()`  | Label the X-axis           |
| `plt.ylabel()`  | Label the Y-axis           |
| `plt.legend()`  | Add a legend               |
| `plt.grid()`    | Add a grid                 |
| `plt.show()`    | Display the graph          |
| `plt.savefig()` | Save the graph as an image |
